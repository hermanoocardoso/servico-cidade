...
CATEGORIAS_PADRAO = [
    ...
    ("Cabeleireiro", "Beleza e Autocuidado"),
    ("Manicure", "Beleza e Autocuidado"),
    ("Podóloga", "Beleza e Autocuidado"),
    ("Barbeiro", "Beleza e Autocuidado"),
    ("Salão de Beleza", "Beleza e Autocuidado"),
    ("Maquiador(a)", "Beleza e Autocuidado"),

    ("Fotógrafo", "Eventos"),
    ("Confeiteiro(a) / Doceiro(a)", "Eventos"),
    ("Buffet / Garçom", "Eventos"),
    ("DJ / Som", "Eventos"),
    ("Decoração de festas", "Eventos"),
